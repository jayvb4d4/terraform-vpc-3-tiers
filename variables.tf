...
variable "keyname1" {
  type        = string
  default     = ""
  description = "keyname1"
}

variable "keyname2" {
  type        = string
  default     = "keyname2"
  description = "keyname2"
}

variable "keyname3" {
  type        = string
  default     = "keyname3"
  description = "keyname3"
}

variable "tag_keyname1" {
  type        = string
  default     = ""
  description = "tag_keyname1"
}

variable "tag_keyname2" {
  type        = string
  default     = "tag_keyname2"
  description = "tag_keyname2"
}

variable "tag_keyname3" {
  type        = string
  default     = ""
  description = "tag_keyname3"
}
...
variable "public_subnent_name_1" {
  type        = string
  default     = "public_subnent_name_1"
  description = "public_subnent_name_1"
}
...
variable "public_subnent_name_2" {
  type        = string
  default     = "public_subnent_name_2"
  description = "public_subnent_name_2"
}
